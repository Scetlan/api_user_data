...
export function UserBlock({ avatarSrc, username }: IUsetBlockProps) {
  return (
    ...
    href="https://www.reddit.com/api/v1/authorize?client_id=nX9OpC-uNuyAX6uskR7HIQ&response_type=code&state=RANDOM_STRING&redirect_uri=http://localhost:3000&scope=identity read submit">
